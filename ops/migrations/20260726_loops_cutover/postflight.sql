...
BEGIN
  ...
  SELECT count(*) INTO violations FROM pg_constraint WHERE conname ILIKE '%project%'
    AND conrelid IN ('public.loops'::regclass,'public.loop_events'::regclass,'public.loop_work_items'::regclass,'public.work_items'::regclass);
