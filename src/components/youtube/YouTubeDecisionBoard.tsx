...
const RESPONSIBILITY_BADGES: Record<YouTubeBoardBucketKey, { label: string; className: string }> = {
  needs_gonza: { label: "Human decision", className: "border-indigo-500/30 bg-indigo-500/10 text-indigo-300" },
...
const BOARD_GROUPS: Array<{ key: YouTubeBoardBucketKey; title: string; description: string }> = [
  { key: "needs_gonza", title: "Needs Gonza", description: "Only the items that need human judgment or approval." },
  { key: "agent_working", title: "Agent Working", description: "The YouTube Director already has an open task on these." },
  { key: "agent_next", title: "Agent Next", description: "Automation should move these forward next." },
