...
export function CreateLoopModal({ onClose }: { onClose: () => void }) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
      <div className="w-full max-w-xl rounded-xl border border-gray-700 bg-[#0d0d14] shadow-2xl">
        <div className="flex items-center justify-between border-b border-gray-800 px-6 py-4">
          <h2 className="text-lg font-semibold text-white">New Loop</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 px-6 py-4">
          <textarea
            ...
            placeholder="Describe the loop you want to start..."
            required
            autoFocus
            rows={5}
