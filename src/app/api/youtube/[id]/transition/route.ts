...
function createStageAutomationInstruction(input: {
  ...
  if (input.stage === "title_thumbnail") {
    return [
      ...
      "- Contrast the idea against AIPaths channel patterns that have worked: concrete problem/object, clear promise, clear viewer, simple tension, and fit with the channel pillars.",
      "",
